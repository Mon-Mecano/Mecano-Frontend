...
let chartExample1 = {
  data1: (canvas) => {
    ...
    gradientStroke.addColorStop(1, "rgba(0, 255, 191,0.2)");
      ...
      datasets: [
        {
          ...
          pointBackgroundColor: "rgb(0, 153, 92)",
          ...
          pointRadius: 4,
          data: [100, 70, 90, 70, 85, 30, 75,100, 70, 90, 70, 85, 60, 75,100, 70, 90, 70, 85, 60, 75,90, 70, 85,],
        },
      ],
    };
  },
